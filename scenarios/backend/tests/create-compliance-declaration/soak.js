...
import { SOAK, soakThresholds } from '../../lib/load-model.js';
import { buildHandleSummary } from '../../lib/summary.js';

// 2h soak — LOCAL ONLY. Excluded from TEST_SCENARIO=all and hard-blocked by
// entrypoint.sh when CI=true. Trigger locally with:
//   TEST_SCENARIO=create-compliance-declaration/soak.js ./scenarios/backend/entrypoint.sh
export const options = {
  scenarios: { load: SOAK },
  thresholds: soakThresholds(SOAK.rate),
};
...
export const handleSummary = buildHandleSummary(
  __ENV.RESULTS_DIR || 'results/create-compliance-declaration/soak',
);
