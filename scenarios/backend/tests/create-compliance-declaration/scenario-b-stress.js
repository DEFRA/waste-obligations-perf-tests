...
import { SCENARIO_B, WRITE_VU_OVERRIDES, constantThresholds } from '../../lib/load-model.js';
import { buildHandleSummary } from '../../lib/summary.js';

export const options = {
  scenarios: { load: { ...SCENARIO_B, ...WRITE_VU_OVERRIDES.scenarioB } },
  thresholds: constantThresholds(SCENARIO_B.rate, 1000),
};
...
export const handleSummary = buildHandleSummary(
  __ENV.RESULTS_DIR || 'results/create-compliance-declaration/scenario-b-stress',
);
